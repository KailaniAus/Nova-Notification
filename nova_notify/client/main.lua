--[[
    COPYRIGHT (C) 2022 NOVACANE. ALL RIGHTS RESERVED.
    DO NOT DISTRIBUTE WITHOUT PERMISSION.
    Email: finneykai76@gmail.com@gmail.com
    Github: https://github.com/KailaniAus
]]
...
RegisterNetEvent('nova_notify:client:SendAlert')
AddEventHandler('nova_notify:client:SendAlert', function(data)
	DoCustomHudText(data.type, data.text, data.length, data.style)
end)

RegisterNetEvent('nova_notify:client:PersistentHudText')
AddEventHandler('nova_notify:client:PersistentHudText', function(data)
